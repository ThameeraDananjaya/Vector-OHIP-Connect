...
const tabs = [
  {
    ...
    name: "Distribution",
    icon: Globe,
    env: "distribution" as EnvironmentId,
  },
  {
    id: "property",
    name: "OPERA Property",
    icon: Hotel,
    env: "opera_cloud" as EnvironmentId,
  },
  {
    id: "workflows",
  ...
  },
  {
    ...
    name: "R&A Data APIs",
    icon: BarChart3,
    env: "ra_storage" as EnvironmentId,
  },
  {
    id: "ra_storage",
...
export default function AppClient() {
  ...
  const [activeSetupTab, setActiveSetupTab] =
    useState<EnvironmentId>("opera_cloud");
          ...
          <div className="flex items-center justify-center h-[calc(100vh-120px)]">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                The requested API module could not be loaded.
              </p>
            </div>
          </div>
        )}
